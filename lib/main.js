...
server_1.default.use(mount('/api/auth', auth_1.default.routes()));
server_1.default.use(mount('/api/auth', auth_1.default.allowedMethods()));
server_1.default.use(mount('/api/photosets', photosets_1.default.routes()));
server_1.default.use(mount('/api/photosets', photosets_1.default.allowedMethods()));
